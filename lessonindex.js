...
/* trying to display or routing content on a browser using express package */
const express = require("express"); // require is a keyword used to use a package i.e express// require is a keyword used to use the express package used for routing
...
/* for geting the posted data from the form in the console and the output is json */
